...
export const Contact = ({}: Props) => {
  const socialLinks: { href: string; icon: JSX.Element; alt: string }[] = [
    {
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            <h2 className="headline-2 lg:max-w-[12ch]">
              Me contate para uma conversa
            </h2>
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
              Conecte-se comigo para engajar em um diálogo sobre tecnologias
              atuais e descobrir experiências inovadoras!
            </p>
          ...
          <form
            action="https://getform.io/f/bpjjlyxb"
            method="POST"
